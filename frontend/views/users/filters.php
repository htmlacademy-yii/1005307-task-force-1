<div class="content-view__feedback-card user__search-wrapper">
    <div class="feedback-card__top">
        <div class="user__search-icon">
            ...
            <span><?= $user['finished_task_count'] ?> <?= $formatter->getNounPluralForm($user['finished_task_count'], 'задание', 'задания', 'заданий') ?></span>
            <span><?= $user['opinions_count'] ?> <?= $formatter->getNounPluralForm($user['opinions_count'], 'отзыв', 'отзыва', 'отзывов') ?></span>
        </div>
        ...
        <span
            class="new-task__time">Был на сайте <?= $formatter->asRelativeTime($user['last_activity_time'], strftime("%F %T")) ?></span>
    </div>
