    ...
    <div class="main-container page-container">
        <section class="menu-toggle">
            <ul class="menu-toggle__list">
                <li class="menu-toggle__item <?= $status_task === 'Выполнено' ? 'menu_toggle__item--current' : '' ?> menu-toggle__item--completed">
                    <div class="menu-toggle__svg-wrapper">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path <?php if ($status_task === 'Выполнено'): ?> fill="white" <?php endif; ?>
                    ...
                    <a href="<?= Url::to(['my-tasks/index', 'status_task' => 'Выполнено']) ?>">
                        Завершённые
                    </a>
                </li>
                <?php if (isset($user->user_role) && $user->user_role === 'client'): ?>
                    <li class="menu-toggle__item <?= $status_task === 'Новое' ? 'menu_toggle__item--current' : '' ?> menu-toggle__item--new">
                        <div class="menu-toggle__svg-wrapper">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <rect <?php if (isset($status_task) && $status_task === 'Новое'): ?> fill="white" <?php endif; ?>
                                    opacity="0.01" x="24" y="24" width="24" height="24" transform="rotate(180 24 24)"/>
                                <path <?php if (isset($status_task) && $status_task === 'Новое'): ?> fill="white" <?php endif; ?>
                        ...
                        <a href="<?= Url::to(['my-tasks/index', 'status_task' => 'Новое']) ?>">
                            Новые
                        </a>
                    </li>
                <?php endif; ?>
                <li class="menu-toggle__item <?= $status_task == 'На исполнении' ? 'menu_toggle__item--current' : '' ?> menu-toggle__item--active">
                    ...
                    <a href="<?= Url::to(['my-tasks/index', 'status_task' => 'На исполнении']) ?>">
                        Активные
                    </a>
                </li>
                <li class="menu-toggle__item <?php if (isset($status_task) && $status_task === 'Провалено' || $status_task === 'Отмененное'): ?> menu_toggle__item--current <?php endif; ?> menu-toggle__item--canceled">
                    <div class="menu-toggle__svg-wrapper">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path <?php if (isset($status_task) && $status_task === 'Провалено' || $status_task === 'Отмененное'): ?> fill="white" <?php endif; ?>
                                fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <a href="<?= Url::to(['my-tasks/index', 'status_task' => 'Отмененное']) ?>">
                        Отменённые
                    </a>
                </li>
                <li class="menu-toggle__item <?= isset($status_task) && $status_task === 'Просроченное' ? 'menu_toggle__item--current' : '' ?> menu-toggle__item--hidden">
                    <div class="menu-toggle__svg-wrapper">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect <?php if (isset($status_task) && $status_task === 'Просроченное'): ?> fill="white" <?php endif; ?>
                                opacity="0.01" x="24" width="24" height="24" transform="rotate(90 24 0)"/>
                            <path <?php if (isset($status_task) && $status_task === 'Просроченное'): ?> fill="white" <?php endif; ?>
                                fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <a href="<?= Url::to(['my-tasks/index', 'status_task' => 'Просроченное']) ?>">
                        Просроченные
                    </a>
                </li>
            </ul>
        ...
        <section class="my-list">
            ...
            <div class='new-task__pagination'>{pager}</div>",
                'emptyText' => '<div class="my-list__wrapper">
