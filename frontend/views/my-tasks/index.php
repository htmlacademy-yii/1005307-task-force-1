    ...
    <div class="main-container page-container">
        <section class="menu-toggle">
            <ul class="menu-toggle__list">
                ...
                <li class="menu-toggle__item <?php if($status_task == 'Провалено' || $status_task == 'Отменено'):?> menu_toggle__item--current <?php endif; ?> menu-toggle__item--canceled">
                    <div class="menu-toggle__svg-wrapper">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path <?php if($status_task == 'Провалено' || $status_task == 'Отменено'):?> fill="white" <?php endif; ?>
                                fill-rule="evenodd" clip-rule="evenodd"
