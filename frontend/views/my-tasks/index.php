        ...
        <section class="menu-toggle">
            <ul class="menu-toggle__list">
                ...
                <li class="menu-toggle__item <?= $status_task === 'Новое' ? 'menu_toggle__item--current' : ''?> menu-toggle__item--new">
                    <div class="menu-toggle__svg-wrapper">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect <?php if ($status_task === 'Новое'): ?> fill="white" <?php endif; ?> opacity="0.01" x="24" y="24" width="24" height="24" transform="rotate(180 24 24)"/>
                ...
                <li class="menu-toggle__item <?= $status_task === 'На исполнении' ? 'menu_toggle__item--current' : ''?> menu-toggle__item--active">
                    <div class="menu-toggle__svg-wrapper">
                        <svg width="21" height="19" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path <?php if ($status_task === 'На исполнении'): ?> fill="white" <?php endif; ?> fill-rule="evenodd" clip-rule="evenodd"
                ...
                <li class="menu-toggle__item <?= $status_task === 'Отмененное' ? 'menu_toggle__item--current' : ''?> menu-toggle__item--canceled">
                    <div class="menu-toggle__svg-wrapper">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path <?php if ($status_task === 'Отмененное'): ?> fill="white" <?php endif; ?> fill-rule="evenodd" clip-rule="evenodd"
                ...
                <li class="menu-toggle__item <?= $status_task === 'Провалено' ? 'menu_toggle__item--current' : ''?> menu-toggle__item--hidden">
                    <div class="menu-toggle__svg-wrapper">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect <?php if ($status_task === 'Провалено'): ?> fill="white" <?php endif; ?> opacity="0.01" x="24" width="24" height="24" transform="rotate(90 24 0)"/>
                            <path <?php if ($status_task === 'Провалено'): ?> fill="white" <?php endif; ?> fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <a href="<?= Url::to(['my-tasks/index', 'status_task' => 'Провалено']) ?>">
                        Проваленые
                    </a>
                </li>
            </ul>
