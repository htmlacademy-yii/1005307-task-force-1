...
<div class="new-task__card">
    <div class="new-task__title">
        ...
        <a href="<?= Url::to(['tasks/filter', 'category_id' => strip_tags($model['cat_id'])]) ?>" class="link-regular">
            <?= $model['cat_name'] ?>
        </a>
    </div>
    <div class="new-task__icon new-task__icon--<?= strip_tags($model['cat_icon']) ?>"></div>
    <p class="new-task_description">
        <?= htmlspecialchars($model['description']) ?>
    </p>
    <b class="new-task__price new-task__price--<?= strip_tags($model['cat_icon']) ?>">
