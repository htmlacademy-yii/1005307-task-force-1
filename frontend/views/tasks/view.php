...
<section class="modal completion-form form-modal" id="complete-form">
    ...
    ?>
    <?= $form->field($completeForm, 'doer_id', [
        'inputOptions' => [
            'value' => $task['doer_id'],
            'type' => 'hidden',
        ]
    ])->label(false); ?>
    <?= $form->field($completeForm, 'client_id', [
        'inputOptions' => [
            'value' => $task['client_id'],
            'type' => 'hidden',
        ]
    ])->label(false); ?>
    <?= $form->field($completeForm, 'task_id', [
        'inputOptions' => [
            'value' => $task['id'],
            'type' => 'hidden',
        ]
    ])->label(false); ?>
    <?= $form->field($completeForm, 'completion', [
    ...
    <?= $form->field($completeForm, "description", [
        'template' => "<p>{label}\n{input}\n{error}</p>",
        'inputOptions' => [
            'class' => 'input textarea',
